...
import com.google.code.tinypmclient.internal.resource.*;
...
public class ClientFactory {
    ...
    private Timesheets timesheetsClient;
    ...
    public Timesheets getTimesheets() {
        if (timesheetsClient == null) {
            timesheetsClient = createProxy(Timesheets.class);
        }
